...
const AuthLayout = () => {
  return (
    <div className="relative min-h-screen bg-white overflow-hidden p-8">
      ...
      <div className="flex flex-col lg:flex-row-reverse relative z-10 min-h-[80vh] mt-10 md:mt-20 lg:mt-0">
        ...
        <div className="flex-1 flex justify-center items-start md:mt-10">
          <Outlet />
        </div>
      </div>
    </div>
